    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Lab Kimia', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://github.com/nasirkhan/laravel-starter/">Built with ♥ from Lab Kimia</a>', // default value if you want
            ],
            [
